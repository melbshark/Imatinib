...
#else // !(_ATL_VER >= 0x0700)
		m_hResource = ::FindResource(_pModule->GetResourceInstance(), ID.m_lpstr, Type.m_lpstr);
#endif // !(_ATL_VER >= 0x0700)
		if(m_hResource == NULL)
			return false;
...
#else // !(_ATL_VER >= 0x0700)
		m_hGlobal = ::LoadResource(_pModule->GetResourceInstance(), m_hResource);
#endif // !(_ATL_VER >= 0x0700)
		if(m_hGlobal == NULL)
		{
			m_hResource = NULL;
...
#else // !(_ATL_VER >= 0x0700)
		m_hResource = ::FindResourceEx(_pModule->GetResourceInstance(), ID.m_lpstr, Type.m_lpstr, wLanguage);
#endif // !(_ATL_VER >= 0x0700)
		if(m_hResource == NULL)
			return false;
...
#else // !(_ATL_VER >= 0x0700)
		return ::SizeofResource(_pModule->GetResourceInstance(), m_hResource);
#endif // !(_ATL_VER >= 0x0700)
	}
