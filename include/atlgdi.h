...
inline LPBITMAPINFOHEADER AtlGetBitmapResourceInfo(HMODULE hModule, _U_STRINGorID image)
{
...
inline WORD AtlGetBitmapResourceBitsPerPixel(HMODULE hModule, _U_STRINGorID image)
{
...
inline WORD AtlGetBitmapResourceBitsPerPixel(_U_STRINGorID image)
{
#if (_ATL_VER >= 0x0700)
	return AtlGetBitmapResourceBitsPerPixel(ATL::_AtlBaseModule.GetResourceInstance(), image);
#else // !(_ATL_VER >= 0x0700)
	return AtlGetBitmapResourceBitsPerPixel(_pModule->GetResourceInstance(), image);
